 ...
 *
 * Tests:
 *   1. /exp/07/batch-geohash  — Geohash-based tile caching (precision 7)
 *   2. /exp/07/batch-h3       — H3-based tile caching (resolution 8)
 *   3. /exp/07/batch-quadkey  — Quadkey-based tile caching (zoom 14)
 *
...
const bench = new Benchmark({
  ...
  resultsDir: path.join(ROOT, "benchmark-results", "07_spatial_tile_cache"),
  ...
  experiments: [
    // ── Geohash (precision 7) ────────────────────────────────────────────────
    {
      ...
      extraEnv: {
        METHOD: "POST",
        TARGET_URL: `${BASE_URL}/exp/07/batch-geohash`,
    ...
    // ── H3 (resolution 8) ────────────────────────────────────────────────────
    {
      ...
      extraEnv: {
        METHOD: "POST",
        TARGET_URL: `${BASE_URL}/exp/07/batch-h3`,
        BODY: JSON.stringify({ points: randomPoints(1000) }),
      },
    },
    ...
    // ── Quadkey (zoom 14) ────────────────────────────────────────────────────
    {
      ...
      extraEnv: {
        METHOD: "POST",
        TARGET_URL: `${BASE_URL}/exp/07/batch-quadkey`,
        BODY: JSON.stringify({ points: randomPoints(1000) }),
      },
    },
  ],
